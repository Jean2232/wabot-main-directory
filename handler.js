    ...
    try {
      ...
      try {
        ...
        if (chat = global.DATABASE._data.chats[m.chat]) {
          ...
          if (!'interacoes' in chat) chat.interacoes = true
...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: 'Este comando só pode ser usado pelo *Jeannn*',
    owner: 'Este comando só pode ser usado pelo *Jeannn*',
    mods: 'Este comando só pode ser usado por moderadores do bot!!!',
    premium: 'Este comando só pode ser usado pelos moderadores do bot!!!',
    group: 'Este comando só pode ser usado em grupos!!!',
    private: 'Este comando só pode ser usado no chat privado!!!',
    admin: 'Este comando só pode ser usado por *admins* do grupo!!!',
    botAdmin: 'Este comando só pode ser usado quando o *bot* se torna admin do grupo!!!',
    unreg: 'Este comando só pode ser usado por usuarios registrados!!!'
  }[type]
...
fs.watchFile(file, () => {
  fs.unwatchFile(file)
  console.log(chalk.redBright("Alteração em 'handler.js'"))
